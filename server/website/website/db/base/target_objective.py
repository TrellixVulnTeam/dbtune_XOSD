...
class TargetObjectives:
    ...
    def register(self):
        ...
        from ..dm.target_objective import target_objective_list as _dm_list  # pylint: disable=import-outside-toplevel

        if not self.registered():
            LOG.info('Registering target objectives...')
            full_list = _myrocks_list + _oracle_list + _postgres_list + _mysql_list + _dm_list
